...
//						printf("cartridgeClass : %s gPrinterStatus : %s \n",printerStatus.cartridgeClass, gPrinterStatus.cartridgeClass);
...
//						printf("printerStatus : %s gPrinterStatus : %s \n",printerStatus.cartridgeStatus, gPrinterStatus.cartridgeStatus);
